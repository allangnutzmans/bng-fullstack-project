        ...
        <div class="col-sm-8 col-10">
            <div class="card p-4">
                ...
                <div class="text-center my-3">
                    <a href="?ct=Admin&mt=agentsManagment" class="btn btn-secondary px-4"><i class="fa-solid fa-xmark me-2"></i>Não</a>
                    <a href="?ct=Admin&mt=recoverAgentConfirm&id=<?=  aes_encrypt($agent->id) ?>" class="btn btn-secondary px-4"><i class="fa-solid fa-check me-2"></i>Sim</a>
                </div>
