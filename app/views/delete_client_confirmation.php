        ...
        <div class="col-sm-8 col-10">
            <div class="card p-4">
                ...
                <div class="text-center my-3">
                    <a href="?ct=Agent&mt=myClients" class="btn btn-outline-secondary px-5"><i class="fa-solid fa-xmark me-2"></i>Não</a>
                    <a href="?ct=Agent&mt=deleteClientConfirm&id=<?= aes_encrypt($client->id) ?>" class="btn btn-secondary px-5"><i class="fa-solid fa-check me-2"></i>Sim</a>
                </div>
